...
Route::post('/child/postregister-step1','ChildController@postregisterStep1')->name('postregister1');
Route::post('/child/postregister-step2','ChildController@postregisterStep2')->name('postregister2');
